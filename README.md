...
Sử dụng Power BI để trực quan hóa dữ liệu nhằm hiểu sâu về bộ dữ liệu và các nhóm khách hàng.
Kết quả của dự án này: xác định được 02 nhóm khách hàng chính cần quan tâm, ngoài ra còn phát hiệu một số insight đáng chú ý. Từ đó, đề xuất giải pháp kinh doanh cho doanh nghiệp
